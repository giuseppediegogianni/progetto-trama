...
Chi deve ingaggiare qualcuno (un gruppo musicale, un cantiere, una squadra, un progetto) non cerca "il punteggio più alto ovunque": cerca **quella forma precisa**, coi suoi vuoti. Non esiste una ragnatela "migliore" verso cui tutti convergono per essere scelti — esistono tante domande diverse (progetti, mestieri, opportunità) che cercano forme diverse. Per questo motivo il rischio della legge di Goodhart (la misura diventa l'obiettivo e smette di essere una buona misura, vedi [[Il modello ibrido uomo-macchina]]) si disinnesca in gran parte da solo: non c'è un unico bersaglio verso cui ottimizzarsi.
...
## Perché è meglio dei voti
- Non è una linea piatta di numeri, ma una rappresentazione visiva immediata, a più livelli di dettaglio.
- Il ragazzo vede il proprio profilo reale, non un giudizio.
- È più umana e onesta del voto tradizionale: non giudica, descrive.

## Nessun modello esistente lo fa
Dalla ricerca in [[00 - Confronto scuole alternative]]: nessuna delle 10 scuole analizzate usa un profilo multi-asse evolutivo come sistema di valutazione primario. L'IB si avvicina di più con i sei gruppi di materie, ma poi li **somma in un unico punteggio su 45** — l'esatto opposto della ragnatela (vedi [[Scuole alternative/IB]]).
